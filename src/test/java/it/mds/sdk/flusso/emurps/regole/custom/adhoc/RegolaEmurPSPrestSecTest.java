...
class RegolaEmurPSPrestSecTest {
    @Mock
    ...
    void init(){
        ...
        regola = spy(new RegolaEmurPSPrestSec("TEST", "TEST", "TEST", parametriTest));
    }
    ...
    void costruttoreVuoto() {
        RegolaEmurPSPrestSec regola = new RegolaEmurPSPrestSec();
        assertTrue(regola instanceof RegolaEmurPSPrestSec);
    }
    ...
    void validaKO2() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        prestazioneSecondaria.setValue("val");
        ArrayList<PrestazioneSecondaria> lstCampo = new ArrayList<PrestazioneSecondaria>();
        lstCampo.add(prestazioneSecondaria);
