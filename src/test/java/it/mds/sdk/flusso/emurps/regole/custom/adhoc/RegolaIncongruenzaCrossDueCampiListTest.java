...
class RegolaIncongruenzaCrossDueCampiListTest {
    @Mock
    ...
    RegolaIncongruenzaCrossDueCampiList regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaIncongruenzaCrossDueCampiList("TEST", "TEST", "TEST", parametriTest));
    }

    @Test
    void costruttoreVuoto() {
        RegolaIncongruenzaCrossDueCampiList regola = new RegolaIncongruenzaCrossDueCampiList();
        assertTrue(regola instanceof RegolaIncongruenzaCrossDueCampiList);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("operatoreLogico")).thenReturn("or");
    ...
    void validaKO2() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("operatoreLogico")).thenReturn("or");
        Mockito.when(recordMockito.getCampo("nomeCampoCondizionante")).thenReturn("10");
        Mockito.when(recordMockito.getCampo("nomeCampoCondizionante2")).thenReturn("10");
