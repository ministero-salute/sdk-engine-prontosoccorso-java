...
class RegolaEmurPSPrestPrincOBITest {
    @Mock
    ...
    RegolaEmurPSPrestPrincOBI regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaEmurPSPrestPrincOBI("TEST", "TEST", "TEST", parametriTest));
    }
    ...
    void costruttoreVuoto() {
        RegolaEmurPSPrestPrincOBI regola = new RegolaEmurPSPrestPrincOBI();
        assertTrue(regola instanceof RegolaEmurPSPrestPrincOBI);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("assistitoOBIPrestazionePrincipaleErogata")).thenReturn("");
