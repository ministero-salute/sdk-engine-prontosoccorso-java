...
class RegolaEmurPSTraumaTest {
    ...
    void init(){
        ...
        regola = spy(new RegolaEmurPSTrauma("TEST", "TEST", "TEST", parametriTest));
    }

    @Test
    void costruttoreVuoto() {
        RegolaEmurPSTrauma regola = new RegolaEmurPSTrauma();
        assertTrue(regola instanceof RegolaEmurPSTrauma);
    }
    ...
    void validaKO() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("problemaPrincipale")).thenReturn("10");
