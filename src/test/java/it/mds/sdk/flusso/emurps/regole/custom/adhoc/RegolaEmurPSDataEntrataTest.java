...
class RegolaEmurPSDataEntrataTest {
    @Mock
    ...
    RegolaEmurPSDataEntrata regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaEmurPSDataEntrata("TEST", "TEST", "TEST", parametriTest));
    }

    @Test
    void costruttoreVuoto() {
        RegolaEmurPSDataEntrata regola = new RegolaEmurPSDataEntrata();
        assertTrue(regola instanceof RegolaEmurPSDataEntrata);
    }
    ...
    void validaKO() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("dataEntrata")).thenReturn("2022-01-20");
