...
class RegolaEmurPSDataDestTest {
    @Mock
    ...
    void init(){
        ...
        regola = spy(new RegolaEmurPSDataDest("TEST", "TEST", "TEST", parametriTest));
    }

    @Test
    void costruttoreVuoto() {
        RegolaEmurPSDataDest regola = new RegolaEmurPSDataDest();
        assertTrue(regola instanceof RegolaEmurPSDataDest);
    }
