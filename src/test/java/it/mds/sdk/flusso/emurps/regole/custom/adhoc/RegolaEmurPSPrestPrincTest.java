...
class RegolaEmurPSPrestPrincTest {
    @Mock
    ...
    void init(){
        ...
        regola = spy(new RegolaEmurPSPrestPrinc("TEST", "TEST", "TEST", parametriTest));
    }
    ...
    void costruttoreVuoto() {
        RegolaEmurPSPrestPrinc regola = new RegolaEmurPSPrestPrinc();
        assertTrue(regola instanceof RegolaEmurPSPrestPrinc);
    }
    ...
    void validaKO() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("assistitoPrestazioniPrestazionePrestazionePrincipale")).thenReturn("10");
        Mockito.when(recordMockito.getCampo("assistitoDatiAnagraficiResidenzaRegione")).thenReturn("10");
