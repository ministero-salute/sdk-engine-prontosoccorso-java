...
class RegolaEmurPSRicoveroProgressivoTest {
    @Mock
    ...
    RegolaEmurPSRicoveroProgressivo regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaEmurPSRicoveroProgressivo("TEST", "TEST", "TEST", parametriTest));
    }

    @Test
    void costruttoreVuoto() {
        RegolaEmurPSRicoveroProgressivo regola = new RegolaEmurPSRicoveroProgressivo();
        assertTrue(regola instanceof RegolaEmurPSRicoveroProgressivo);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("assistitoDimissioneRicoveroProgressivo")).thenReturn("");
        Mockito.when(recordMockito.getCampo("assistitoDimissioneData")).thenReturn("");
