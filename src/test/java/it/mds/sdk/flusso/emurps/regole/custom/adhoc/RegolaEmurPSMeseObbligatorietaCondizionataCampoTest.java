...
class RegolaEmurPSMeseObbligatorietaCondizionataCampoTest {
    @Mock
    ...
    RegolaEmurPSMeseObbligatorietaCondizionataCampo regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaEmurPSMeseObbligatorietaCondizionataCampo("TEST", "TEST", "TEST", parametriTest));
    }

    @Test
    void costruttoreVuoto() {
        RegolaEmurPSMeseObbligatorietaCondizionataCampo regola = new RegolaEmurPSMeseObbligatorietaCondizionataCampo();
        assertTrue(regola instanceof RegolaEmurPSMeseObbligatorietaCondizionataCampo);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("entrataData")).thenReturn("2022-01-01");
