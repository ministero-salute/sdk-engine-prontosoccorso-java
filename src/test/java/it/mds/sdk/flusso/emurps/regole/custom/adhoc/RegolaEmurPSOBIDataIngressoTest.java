...
class RegolaEmurPSOBIDataIngressoTest {
    @Mock
    ...
    RegolaEmurPSOBIDataIngresso regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaEmurPSOBIDataIngresso("TEST", "TEST", "TEST", parametriTest));
    }

    @Test
    void costruttoreVuoto() {
        RegolaEmurPSOBIDataIngresso regola = new RegolaEmurPSOBIDataIngresso();
        assertTrue(regola instanceof RegolaEmurPSOBIDataIngresso);
    }
