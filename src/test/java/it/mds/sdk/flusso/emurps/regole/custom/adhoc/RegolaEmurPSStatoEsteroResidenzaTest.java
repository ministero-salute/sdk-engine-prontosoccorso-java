...
class RegolaEmurPSStatoEsteroResidenzaTest {
    @Mock
    ...
    RegolaEmurPSStatoEsteroResidenza regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaEmurPSStatoEsteroResidenza("TEST", "TEST", "TEST", parametriTest));
    }

    @Test
    void costruttoreVuoto() {
        RegolaEmurPSStatoEsteroResidenza regola = new RegolaEmurPSStatoEsteroResidenza();
        assertTrue(regola instanceof RegolaEmurPSStatoEsteroResidenza);
    }
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("assistitoDatiAnagraficiResidenzaComune")).thenReturn("010010");
