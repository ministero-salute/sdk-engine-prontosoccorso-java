...
class RegolaEmurPSOBIDataUscitaTest {
    @Mock
    ...
    RegolaEmurPSOBIDataUscita regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaEmurPSOBIDataUscita("TEST", "TEST", "TEST", parametriTest));
    }

    @Test
    void costruttoreVuoto() {
        RegolaEmurPSOBIDataUscita regola = new RegolaEmurPSOBIDataUscita();
        assertTrue(regola instanceof RegolaEmurPSOBIDataUscita);
    }
