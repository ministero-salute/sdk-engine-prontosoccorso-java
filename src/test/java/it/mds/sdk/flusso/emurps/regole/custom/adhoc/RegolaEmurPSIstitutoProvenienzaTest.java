...
class RegolaEmurPSIstitutoProvenienzaTest {
    @Mock
    ...
    RegolaEmurPSIstitutoProvenienza regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaEmurPSIstitutoProvenienza("TEST", "TEST", "TEST", parametriTest));
    }
    ...
    void costruttoreVuoto() {
        RegolaEmurPSIstitutoProvenienza regola = new RegolaEmurPSIstitutoProvenienza();
        assertTrue(regola instanceof RegolaEmurPSIstitutoProvenienza);
    }
    ...
    void validaKO() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("istitutoProvenienza")).thenReturn("120201");
        Mockito.when(recordMockito.getCampo("responsabileInvio")).thenReturn("4");
