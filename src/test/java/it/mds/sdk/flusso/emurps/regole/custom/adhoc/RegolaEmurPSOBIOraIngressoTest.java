...
class RegolaEmurPSOBIOraIngressoTest {
    @Mock
    ...
    RegolaEmurPSOBIOraIngresso regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaEmurPSOBIOraIngresso("TEST", "TEST", "TEST", parametriTest));
    }

    @Test
    void costruttoreVuoto() {
        RegolaEmurPSOBIOraIngresso regola = new RegolaEmurPSOBIOraIngresso();
        assertTrue(regola instanceof RegolaEmurPSOBIOraIngresso);
    }
