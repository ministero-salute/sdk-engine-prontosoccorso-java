...
public class RegolaIncongruenzaCrossDueCampi extends RegolaGenerica{
	...
	public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
		...
		try {
			...
			String valoreCampoCondizionante = (recordDtoGenerico.getCampo(nomeCampoCondizionante) != null)
					? String.valueOf(recordDtoGenerico.getCampo(nomeCampoCondizionante))
					: "";
