 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CodiceIstituto" type="{http://flussi.mds.it/flsProSoc}codiceIstituto"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Erogatore {
    ...
    @XmlElement(name = "CodiceIstituto", required = true)
    @CsvBindByPosition(position = 1)
    protected String codiceIstituto;

    /**
     * Recupera il valore della propriet� codiceIstituto.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Imposta il valore della propriet� codiceIstituto.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
