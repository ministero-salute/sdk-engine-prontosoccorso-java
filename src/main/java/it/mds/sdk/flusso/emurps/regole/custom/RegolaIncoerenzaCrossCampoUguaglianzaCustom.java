...
public class RegolaIncoerenzaCrossCampoUguaglianzaCustom extends RegolaGenerica{


	public RegolaIncoerenzaCrossCampoUguaglianzaCustom(String nomeRegola, String codErrore, String desErrore, Parametri parametri) {
	...
	public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
		...
		try {
			...
			if (valoreCampo!= null && valoreConfronto.equals(String.valueOf(valoreCampo))) {
...
//				if ("triage".equalsIgnoreCase(nomeCampo)){
//					if(valoreCampoDipendente != null && listaValoriConfronto.contains(valoreCampoDipendente)){
//						listaEsiti.add(creaEsitoOk(nomeCampo));
//					}else{
//						listaEsiti.add(creaEsitoKO(nomeCampo,this.getCodErrore(),"Il campo " + nomeCampo + " é incoerente con " + nomeCampoConfronto));
//					}
//				}else if ("assistitoDimissioneEsitoTrattamento".equalsIgnoreCase(nomeCampo)){
					if(valoreCampoDipendente != null && !listaValoriConfronto.contains(valoreCampoDipendente)){
						listaEsiti.add(creaEsitoOk(nomeCampo));
					}else{
						listaEsiti.add(creaEsitoKO(nomeCampo,this.getCodErrore(),"Il campo " + nomeCampo + " é incoerente con " + nomeCampoConfronto));
